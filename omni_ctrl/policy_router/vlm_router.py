"""VLM-based policy router for NEXUS mixture-of-experts selection.

Implements q_omega(m | l, o_0, M) -- uses a VLM (GPT-4o) to select the best
VLA expert given task description, initial scene observation, and experience memory.
"""
...
# Expert descriptions for the VLM prompt
EXPERT_DESCRIPTIONS = {
    ...
    "openvla": "OpenVLA -- open-source VLA from HuggingFace. Single-step cartesian actions. "
               "Good for simple tasks, less effective for long-horizon manipulation.",
    "octo": "Octo -- generalist transformer policy trained on Open X-Embodiment. "
            "Cartesian delta actions. Good for diverse embodiments.",
}
