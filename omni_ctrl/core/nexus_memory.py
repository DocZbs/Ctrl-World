"""NEXUS experience memory for closed-loop self-evolution.
...
class NexusMemory:
    """Experience memory M for NEXUS closed-loop evolution.
    ...
    def __repr__(self):
        return f"NexusMemory(entries={len(self.entries)}, path={self.save_path})"
