"""LLM-based task proposer for EvoW open-ended task generation.
...
class LLMTaskProposer:
    ...
    Replaces TemplateTaskGenerator for EvoW. Generates batches of tasks
    ...
    def _parse_tasks(self, response_text: str) -> List[Task]:
        ...
        for item in items:
            ...
            tasks.append(Task(
                ...
                task_id=f"evow_{self.task_counter:04d}",
            ))
        return tasks
